...
Spending his last click, <span class="red-font-b">Bart</span> the Runner initiates a <span class="grey-font-b">Run</span> against one of <span class="blue-font-b">Olivia’s</span> <span class="grey-font-b">Remote</span> servers. <span class="red-font-b">Bart</span> has a <span class="red-font-b">Gordian Blade</span>, <span class="red-font-b">Crypsis</span>, and a <span class="red-font-b">Sacrificial Construct</span> installed. He has<span class="red-font-b"> 7</span><span class="nic-red credit"></span>and three cards in his <span class="grey-font-b">Grip</span>. The <span class="grey-font-b">Remote</span> server has an <span class="grey-font-b">Unrezzed</span> card in it and three pieces of <span class="grey-font-b">Ice</span> protecting it, one of them <span class="grey-font-b">Rezzed</span>. The card in the server has one <span class="grey-font-b">Advancement</span> token on it. <span class="blue-font-b">Olivia</span> has<span class="blue-font-b"> 10</span><span class="nic credit"></span>.
