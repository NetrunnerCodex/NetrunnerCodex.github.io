...
slug_subtitle: Essential concepts that shape the structure of the game
slug_image: "/assets/images/slugs/ad_preview-3.jpg"
layout: default
has_children: false
nav_order: 22
---
...
<div class="nav-buttons">
  <a href="/docs/introduction" class="nav-button prev" aria-label="Previous page">
